...
public class Memoir : MonoBehaviour
{
    ...
    private void AddContent(){
        ...
        if(!reachedFreelance){
            ...
            content[2] = "You worked as a freelancer.\n Lots of pain and sweat to earn money.";
            if(withInsurance){
                content[3] = "You are a cautious person.\n You bought the insurance!";
            }
            else{
                content[3] = "You are a risk bearer.\n What is insurance? Never heard of it.";
            }
        }

        //Money
        if(money == 30){
            content[4] = "You're a responsible money maker.\n You earned " + money + " dollars";
        }
        else if(money < 30){
            content[4] = "You have a rough time making money.\n You've only made " + money + " dollars. Should've switch your path huh?";
        }
        else{
            content[4] = "You're an overachiever with an eager to make money.\n Congratulations on making " + money + " dollars!";
        }
    }
